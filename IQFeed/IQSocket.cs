...
namespace QDMSServer.DataSources
{
    ...
    public class Status
    {
        ...
        public int numberOfSymbols
        {
            get
            {
                lock (this) return _numberOfSymbols;
            }
        }
        ...
        public int clientsConnected
        {
            get
            {
                lock (this) return _clientsConnected;
            }
        }
        ...
        public int secondsSinceLastUpdate
        {
            get
            {
                lock (this) return _secondsSinceLastUpdate;
            }
        }
        ...
        public int reconnections
        {
            get
            {
                lock (this) return _reconnections;
            }
        }

        public int attemptedReconnections
        {
            get
            {
                lock (this) return _attemptedReconnections;
            }
        }
        ...
        public bool connected
        {
            get
            {
                lock (this) return _connected;
            }
        }

        public string iqFeedVersion
        {
            get
            {
                lock (this) return _iqFeedVersion;
            }
        }
        ...
        public string loginId
        {
            get
            {
                lock (this) return _loginId;
            }
        }

        public double totalKbsRecv
        {
            get
            {
                lock (this) return _totalKbsRecv;
            }
        }

        public double kbsPerSecRecv
        {
            get
            {
                lock (this) return _kbsPerSecRecv;
            }
        }

        public double avgKbsPerSecRecv
        {
            get
            {
                lock (this) return _avgKbsPerSecRecv;
            }
        }

        public double totalKbsSent
        {
            get
            {
                lock (this) return _totalKbsSent;
            }
        }

        public double kbsPerSecSent
        {
            get
            {
                lock (this) return _kbsPerSecSent;
            }
        }

        public double avgKbsPerSecSent
        {
            get
            {
                lock (this) return _avgKbsPerSecSent;
            }
        }
