...
{
    public class ClientStatsEventArgs : System.EventArgs
    {
        internal ClientStatsEventArgs(string line)
        {
            ...
            lock (this) {
                switch (fields[2]) {
                    case "0":
                        _type = PortType.Admin;
                        break;
                    case "1":
                        _type = PortType.Level1;
                        break;
                    case "2":
                        _type = PortType.Level2;
                        break;
                    default:
                        _type = PortType.Lookup;
                        break;
                }
        ...
        public int symbolsWatched
        {
            get
            {
                lock (this) return _symbolsWatched;
            }
        }

        public int regionalSymbolsWatched
        {
            get
            {
                lock (this) return _regionalSymbolsWatched;
            }
        }
        ...
        public double kbSent
        {
            get
            {
                lock (this) return _kbSent;
            }
        }

        public double kbQueued
        {
            get
            {
                lock (this) return _kbQueued;
            }
        }
    ...
    public class IQAdminSocketClient : SocketClient
    {
        ...
        {
            if (flag) {
                Send("S,CLIENTSTATS ON\r\n");
            }
            else {
                Send("S,CLIENTSTATS OFF\r\n");
            }
        }
