...
namespace QDMS
{
    public class TimeSeries
    {
        ...
        /// </summary>
        public OHLCBar Value { get { return Series[CurrentBar]; } set { Series[CurrentBar] = value; } }
        ...
        {
            return CurrentBar == Series.Count - 1 ? null : Series[CurrentBar + 1];
        }
