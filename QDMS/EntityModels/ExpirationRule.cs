...
{
    /// <summary>
    ///     This class holds a set of rules that collectively can be used to deduce the expiration date of a futures or options
    ///     contract.
    /// </summary>
    [ProtoContract]
    [Serializable]
    public class ExpirationRule
    {
        ...
        /// <summary>
        ///     When using a weekday-based reference day, this sets the number of weeks that must have passed for the reference day
        ///     to be set.
        /// </summary>
        [ProtoMember(8)]
