...
namespace QDMS
{
    ...
    public class HistoricalDataRequest : ICloneable
    {
        ...
        /// </summary>
        public DateTime StartingDate { get { return new DateTime(_longStartingDate); } set { _longStartingDate = value.Ticks; } }

        /// <summary>
        ///     Inclusive ending date for the period requested.
        /// </summary>
        public DateTime EndingDate { get { return new DateTime(_longEndingDate); } set { _longEndingDate = value.Ticks; } }

        [ProtoMember(3)] private long _longStartingDate;

        [ProtoMember(4)] private long _longEndingDate;
        ...
        public object Clone()
        {
            return new HistoricalDataRequest(Instrument, Frequency, StartingDate, EndingDate, DataLocation, SaveDataToStorage, RTHOnly, RequestID)
            {
                AssignedID = AssignedID,
                IsSubrequestFor = IsSubrequestFor,
        ...
        public HistoricalDataRequest(
            ...
            DateTime endingDate,
            DataLocation dataLocation = DataLocation.Both,
